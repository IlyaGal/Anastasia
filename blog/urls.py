...
urlpatterns = [
    ...
    url(r'^Aspirants/AnastasiaKolorova/$', views.stat_anastasia),
    url(r'^AnastasiaKolorova1/$', views.stat_anastasia1),
    url(r'^Aspirants/AnastasiaKolorova/Info/AnastasiaVideo/$', views.stat_anastasiaVideo),
    url(r'^page2/$', views.stat_page2),
    url(r'^page3/$', views.stat_page3),
    url(r'^page4/$', views.stat_page4),
    url(r'^Aspirants/AnastasiaKolorova/AboutAnastasia/$', views.stat_aboutAnastasia),
    url(r'^Aspirants/AnastasiaKolorova/Diagnostic/$', views.stat_diagnostic),
    url(r'^Aspirants/AnastasiaKolorova/Info/$', views.stat_info),
    url(r'^Aspirants/AnastasiaKolorova/Rozvutok/$', views.stat_rozvutok),
